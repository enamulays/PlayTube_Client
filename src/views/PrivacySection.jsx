function PrivacySection() {
  return (
    <div className="h-screen overflow-auto">
      <div className="w-3/5 m-auto  py-20">
        <h6 className="text-center text-sm text-purple-500 mb-5">Privacy Policy</h6>
        <h1 className="text-center text-4xl font-semibold mb-4">We care about your privacy</h1>
        <p className="text-center mb-14 font-light text-sm">{p1}</p>
        <p className=" mb-10 font-light text-sm leading-6">{p2}</p>
        <h2 className="text-2xl font-semibold mb-3">What information do we collect?</h2>
        <p className=" mb-10 font-light text-sm leading-6">{p3}</p>
        <h2  className="text-2xl font-semibold mb-3">How do we use your information</h2>
        <p className=" mb-10 font-light text-sm leading-6">{p4}</p>
        <h2 className="text-2xl font-semibold mb-3">Do we use cookies and other tracking technologies?</h2>
        <p className=" mb-10 font-light text-sm leading-6">{p5}</p>
        <h2 className="text-2xl font-semibold mb-3">How long do we keep tour information?</h2>
        <p className=" mb-10 font-light text-sm leading-6">{p6}</p>
        <h2 className="text-2xl font-semibold mb-3">How do we keep your information safe?</h2>
        <p className=" mb-10 font-light text-sm leading-6">{p7}</p>
        <h2 className="text-2xl font-semibold mb-3">What are your privacy rights</h2>
        <p className=" mb-10 font-light text-sm leading-6">{p8}</p>
        <h2 className="text-2xl font-semibold mb-3">How can you contact us about this policy?</h2>
        <p className=" mb-10 font-light text-sm leading-6">{p9}</p>
      </div>
      <div className=" flex justify-between items-center px-5 pb-5">
        <img src="../image/play_small_icon.PNG" alt="" />
        <h6>©2024 VideoTube. All rights reserved.</h6>
      </div>
    </div>
  );
}
...
Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum fuga asperiores voluptatibus quidem dolores, quos officiis nostrum veritatis. A praesentium dicta temporibus vitae, excepturi sequi itaque? Pariatur veniam praesentium error qui necessitatibus. Et autem dolorum consectetur officia, provident quasi soluta?`;
const p5 = `Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum fuga asperiores voluptatibus quidem dolores, quos officiis nostrum veritatis. A praesentium dicta temporibus vitae, excepturi sequi itaque? Pariatur veniam praesentium error qui necessitatibus. Et autem dolorum consectetur officia, provident quasi soluta?`;
const p6 = `Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum fuga asperiores voluptatibus quidem dolores, quos officiis nostrum veritatis. A praesentium dicta temporibus vitae, excepturi sequi itaque? Pariatur veniam praesentium error qui necessitatibus. Et autem dolorum consectetur officia, provident quasi soluta?`;
const p7 = `Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum fuga asperiores voluptatibus quidem dolores, quos officiis nostrum veritatis. A praesentium dicta temporibus vitae, excepturi sequi itaque? Pariatur veniam praesentium error qui necessitatibus. Et autem dolorum consectetur officia, provident quasi soluta?`;
const p8 = `Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum fuga asperiores voluptatibus quidem dolores, quos officiis nostrum veritatis. A praesentium dicta temporibus vitae, excepturi sequi itaque? Pariatur veniam praesentium error qui necessitatibus. Et autem dolorum consectetur officia, provident quasi soluta?`;
const p9 = `Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum fuga asperiores voluptatibus quidem dolores, quos officiis nostrum veritatis. A praesentium dicta temporibus vitae, excepturi sequi itaque? Pariatur veniam praesentium error qui necessitatibus. Et autem dolorum consectetur officia, provident quasi soluta?
